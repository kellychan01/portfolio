...
import Project1 from '../Projects/Coin'; // Import Project
import Project2 from '../Projects/Letters';
...
const GraphicDesignPopup = ({ onClose }) => {
...
export default GraphicDesignPopup;
