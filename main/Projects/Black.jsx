...
const Black = () => (
    <div className="project-container" id="project7">
        ...
        <section className="project-gallery">
            <img src="../../src/pic/project7/project7-2.jpg" alt="Close-up of the model holding a white mask beside her face, glancing sideways with a subtle smile. Behind her, red candles in an ornate candelabrum glow faintly through cobwebs, with painted cranes and lotus flowers on a folding screen." />
            <img src="../../src/pic/project7/project7-3.jpg" alt="The model sits near a table adorned with candles and a woven basket, holding the white mask near her cheek while smiling softly. The dim, smoky atmosphere is enriched by the detailed painted backdrop of lotus flowers and cranes." />
