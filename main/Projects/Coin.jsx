...
const Coin = () => (
    <div className="project-container" id="project5">
        ...
        <section className="project-gallery">
            <img src="../../public/pic/project5/project5-2.png" alt="The back of the black T-shirt displays a vertical panel of three cartoon coins: a smiling HK$10 coin running, a cheerful HK$2 coin waving, and a happy HK$1 coin hanging upside down." />
            <img src="../../public/pic/project5/project5-3.png" alt="A white illustration of three cartoon Hong Kong coins with smiling faces, wearing shoes, and posing under the text “UTEHKSA EST. 1997,” with three Chinese characters in circular frames at the bottom." />
            <img src="../../public/pic/project5/project5-4.png" alt="A vertical comic-strip style design with three cartoon Hong Kong coins: HK$10 at the top running, HK$2 in the middle waving with both hands, and HK$1 at the bottom hanging playfully." />
        </section>
